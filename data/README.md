...
This directory is for local source and generated working data. The curated,
versioned downloads intended for repository users live separately under
`public-data/`.
...
Only reviewed manual inputs and small source metadata should be committed under
`data/`. Raw downloads and working outputs remain ignored. The deliberate
